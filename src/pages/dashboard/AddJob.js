...
function AddJob() {
  ...
  const handleSubmit = (e)=>{
    ...
    if (isEditing) {
      dispatch(editJob({Id:editJobId,job:{position,company,jobLocation,jobType,status}}))
      return
    }
  ...
  return (
      <Wrapper>
        <form className='form'>
         ...
         <FormRowSelect name='status' id='status' handleChange={handleJobInput} value={status}  list={statusOptions}></FormRowSelect>

            {/*  jobType  */}

          <FormRowSelect name='jobType' labelText='job type' id='jobType' handleChange={handleJobInput} value={jobType}  list={jobTypeOptions}></FormRowSelect>
